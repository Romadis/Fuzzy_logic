...
figure;
hold on;
plot(x_B, mu_B_values, 'r-o', 'LineWidth', 2, 'DisplayName', '\mu_B(x)');
plot(x_B, CON_B_values, 'b-o', 'LineWidth', 2, 'DisplayName', 'CON(B)');
plot(x_B, DIL_B_values, 'g-o', 'LineWidth', 2, 'DisplayName', 'DIL(B)');
hold off;
