...
figure;
hold on;
plot(x, mu_a, 'm', 'LineWidth', 2, 'DisplayName', '\mu_a(x)'); 
plot(x, mu_b, 'g', 'LineWidth', 2, 'DisplayName', '\mu_b(x)');
plot(x, mu_c, 'r', 'LineWidth', 2, 'DisplayName', '\mu_c(x)');
plot(x, mu_d, 'b', 'LineWidth', 2, 'DisplayName', '\mu_d(x)');
hold off;
